...
__all__ = ['logger', 'get_n_samplings', 'get_norm2d', 'get_activation', 'UpsampleConv2d', 'UnsqueezeLatent',
           'SqueezeLogit', 'DownsampleConv2d', 'ConvGenerator', 'ConvDiscriminator', 'get_generater',
...
#         self.logger.experiment.add_hparams({'lr': 0.1*i, 'bsize': i},{})
    ...
    def on_epoch_end(self):
        ...
        sample_images_clamped = sample_images.clamp(0.0, 1.0)
        grid_clmap = torchvision.utils.make_grid(sample_images_clamped)
        self.logger.experiment.add_image('sample_images_clmap', grid_clmap, self.current_epoch)