# AUTOGENERATED! DO NOT EDIT! File to edit: notebooks/gan.loss.ipynb (unless otherwise specified).

__all__ = ['logger', 'get_gan_losses_fns', 'get_adversarial_losses_fns']
